...
loadSound("gameoverSound", "sprites/GameOverLaugh.mp3" )
...
loadSpriteAtlas("flugzeug3.png", {   //player.png = the airplane
    player: {
        x: 0,
        y: 0,
        width: 180,
...
loadSprite("Background3","Background3.webp") //Background
